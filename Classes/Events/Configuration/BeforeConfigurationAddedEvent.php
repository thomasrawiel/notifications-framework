...
final class BeforeConfigurationAddedEvent
{
     ...
     */
    public function __construct(private array $data = [], private int|string|null $newId = null, private ?AbstractEvent $event = null)
    {
    }
    ...
    public function getNewId(): int|string|null
    {
        return $this->newId;
    }
